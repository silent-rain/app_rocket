...
impl UserToken {
    // 获取所有 Token
    pub fn get_all(conn: &MysqlConnection) -> QueryResult<Vec<UserToken>> {
        user_token::table
    ...
    // 查询 Token
    pub fn get_token_by_id(user_id: String, conn: &MysqlConnection) -> QueryResult<UserToken> {
        user_token::table
    ...
    // 添加 Token
    pub fn insert(
        user_token_: &UserTokenInsertOrQuery,
    ...
    // 删除 Token
    pub fn delete_by_id(user_id: String, conn: &MysqlConnection) -> QueryResult<usize> {
